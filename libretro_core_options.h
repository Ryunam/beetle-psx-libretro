...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "video",
      {
         { "disabled", "50Hz (Native PAL)" },
         { "enabled",  "60Hz (Forced NTSC)" },
      },
      "disabled"
   },
   {
      BEETLE_OPT(pal_video_timing_override_toggle_combo),
      "PAL Video Timing Toggle Combo",
      NULL,
      "Define the button combo for toggling the video timing mode for PAL content.",
      NULL,
      "video",
      {
         { "disabled",           NULL },
         ...
         { "R1_R3",              "R1 + R3" },
         { "R2_R3",              "R2 + R3" },
         { "L1_R1_SELECT",       "L1 + R1 + Select" },
         { "L1_R1_START",        "L1 + R1 + Start" },
         { "L2_R2_SELECT",       "L2 + R2 + Select" },
         { "L2_R2_START",        "L2 + R2 + Start" },
         { "L1_L2_R1_R2_SELECT", "L1 + L2 + R1 + R2 + Select" },
         { "L1_L2_R1_R2_START",  "L1 + L2 + R1 + R2 + Start" },
         { "L3_SELECT",          "L3 + Select" },
         { "L3_START",           "L3 + Start" },
         { "R3_SELECT",          "R3 + Select" },
         { "R3_START",           "R3 + Start" },
   ...
   {
      BEETLE_OPT(pal_video_timing_override_notification),
      "PAL Video Timing Notification",
      NULL,
      "Choose if and how to display an onscreen notification that shows the video timing mode applied to PAL content.",
      NULL,
      "osd",
      {
         { "disabled",   NULL },
         { "persistent", "Persistent" },
         { "toggle",     "Upon Toggling" },
         { "all",        "Persistent + Upon Toggling" },
      },
      "toggle"
   },
   {
